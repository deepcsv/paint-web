...
export function registerTempSnapshot(buffer, mime = "image/png", ttlMs = 30_000) {
...
export function registerTempJson(json, ttlMs = 30_000) {
    const id = randomSnapshotId();
 ...
 */
export function createHttpServer(devServer) {
